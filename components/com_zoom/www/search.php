...
|                                                                     |
-----------------------------------------------------------------------
* @version $Id: search.php,v 1.23 2006/12/09 07:32:57 kevinuru Exp $
* @package zOOmGallery
...
if ($type == 'quicksearch') {
    ...
    if(!empty($suchstring)) {   
		...
		<td align="left" valign="top" class="<?php echo $zoom->_tabclass[$tabcnt];?>" colspan="3">
		    ...
		    <?php
		    ZMG_Template_Main::createKeywordsDropdown($zoom->_getKeywordsList(), 'sstring', '<option value="">&gt;&gt;Search by keyword&lt;&lt;</option>', 1);
		    ?>&nbsp;
		    </form>
		</td>
