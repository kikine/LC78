...
|                                                                     |
-----------------------------------------------------------------------
* @version $Id: zoom.class.php,v 1.99 2006/12/09 02:16:04 kevinuru Exp $
* @package zOOmGallery
...
class zoom {
	...
	*/
    ...
    function htmlnumericentities($str) {
        ...
        $str2 = preg_replace('/[^!-%\x27-;=?-~ ]/e', '"&#".ord("$0").chr(59)', $str2);
	...
	function createRatingCSS() {
	    ...
	    $css = ("
    		...
    		.unit-rating{
                ...
                height: 15px;
                position: relative;
                background: url('" . $mosConfig_live_site . "/components/com_zoom/www/images/rating/no_star.gif') top left repeat-x;
            }
            ...
            .unit-rating li a:hover{
                background: url('" . $mosConfig_live_site . "/components/com_zoom/www/images/rating/full_star.gif') left top;
                z-index: 2;
                left: 0px;
            }
            ...
            .unit-rating li.current-rating{
                background: url('" . $mosConfig_live_site . "/components/com_zoom/www/images/rating/full_voting_star.gif') left top;
                position: absolute;
                height: 15px;
                display: block;
                text-indent: -9000px;
