...
define("_ZOOM_SETTINGS_DDONOF","Drag n Drop erlauben");
...
define("_ZOOM_THUMB_DESCR", "Berechne die Zoom Thumb codes einfacher");
...
define("_ZOOM_SETTINGS_TAB4","Wasserzeichen");
define("_ZOOM_SETTINGS_TAB5","Safe Mode");
define("_ZOOM_SETTINGS_TAB6","Berechtigungen");
define("_ZOOM_SETTINGS_TAB7","Zurücksetzen");
define("_ZOOM_SETTINGS_ERASE","Klicken Sie hier, wenn Sie alle Galleriedaten löschen und neu beginnen möchten. Es werden alle Bilder gelöscht und alle Einstellungen zurückgesetzt.");
...
define("_ZOOM_SETTINGS_FEATURES_TITLE","Eigenschaften AN/AUS");
define("_ZOOM_SETTINGS_CSS_TITLE","CSS Einstellungen");
define("_ZOOM_SETTINGS_DISPLAY_TITLE","Anzeigeoptionen AN/AUS");
...
define("_ZOOM_SETTINGS_BOX_PROPERTIES","Eigenschaften (visual state)");
define("_ZOOM_SETTINGS_BOX_META","EXIF-Info (visual state)");
define("_ZOOM_SETTINGS_BOX_COMMENTS","Kommentare (visual state)");
define("_ZOOM_SETTINGS_BOX_RATING","Bewertung (visual state)");
...
define("_ZOOM_SETTINGS_ANONYMOUS_COMMENTS","Zeige anonieme Kommentare");
define("_ZOOM_SETTINGS_WM_ENABLE_TITLE","Wasserzeichen AN/AUS");
define("_ZOOM_SETTINGS_WM_TITLE","Ihr Wasserzeichen");
define("_ZOOM_SETTINGS_WM_IMG","Wasserzeichen");
define("_ZOOM_SETTINGS_WM_PLACEMENT_TITLE","Platzierung");
define("_ZOOM_SETTINGS_WM_PLACEMENT_DESCR","Wähle Sie bitte in der grauen Box die Position des Wasserzeichens aus.");
define("_ZOOM_SETTINGS_WM_FILE","Hochladen eines Wasserzeichens");
define("_ZOOM_SYSTEM_TITLE","System Einstellungen");
define("_ZOOM_YES","Ja");
define("_ZOOM_NO","Nein");
define("_ZOOM_VISIBLE","sichtbar");
...
define("_ZOOM_MOVEFILES","Medien verschieben");
define("_ZOOM_BUTTON_MOVE","Verschieben");
define("_ZOOM_MOVEFILES_STEP1","Ziel Gallerie auswählen &amp; verschiebe Medien");
define("_ZOOM_ALERT_MOVE","%s Medien erfolgreich verschoben, %s Medien konnten nicht verschoben werden.");
define("_ZOOM_OPTIMIZE","Tabellen optimieren");
define("_ZOOM_OPTIMIZE_DESCR","zOOm Media Gallery benutzt viele Tabellen mit teilweise überflüssigen Daten, ie. 'junk data'. Hier klicken um den Müll zu entfernen.");
define("_ZOOM_OPTIMIZE_SUCCESS","zOOm Media Gallery Tabellen optimiert!");
define("_ZOOM_UPDATE","Update zOOm Media Gallery");
define("_ZOOM_UPDATE_DESCR","Neue Features, Probleme lösen and Fehler beheben! Auf <a href=\"http://www.zoomfactory.org\" target=\"_blank\">www.zoomfactory.org</a> sind die neuesten Updates!");
define("_ZOOM_UPDATE_XMLDATE","Zeitstempel des letzten Updates");
define("_ZOOM_UPDATE_NOUPDATES","Keine Updates verfügbar!"); // added 11-08
define("_ZOOM_UPDATE_PACKAGE","Update ZIP-Datei: ");
...
define("_ZOOM_FORM_IGNORESIZES","Voreingestellte Maximalgr&ouml;&szlig;e des Media ignorieren");
...
define("_ZOOM_FLIP_VERT","Spiegel das Bild vertikal");
define("_ZOOM_PROGRESS_DESCR","Anforderung wird bearbeitet, bitte warten.");
...
define ('_ZOOM_INSTALL_CREATE_DIR_WM','zOOm Installation versucht das Medien-Verzeichnis zu erstellen "images/zoom/watermarks" ...');
define ('_ZOOM_INSTALL_CREATE_DIR_SUCC','fertig!');
define ('_ZOOM_INSTALL_CREATE_DIR_FAIL','fehlgeschlagen!');
define ('_ZOOM_INSTALL_CREATE_DBASE_SUCC','Database erfolgreich erzeugt!');
define ('_ZOOM_INSTALL_UPGRADED_DBASE_SUCC','Database erfolgreich geändert!');
