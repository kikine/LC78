...
| Translation: Jorge Muneo Nakagawa - http://www.joanopolis.com.br    |
| License: GPL                                                        |
...
define("_ZOOM_DATEFORMAT","%d.%m.%Y %H:%M");
...
define("_ZOOM_USERSYSTEM","Sistema do usuário");
define("_ZOOM_ADMIN_TITLE","Administração da galeria de imagens");
define("_ZOOM_USER_TITLE","Galeria de imagens do usuário");
define("_ZOOM_CATSMGR","Gerenciador de galeria");
define("_ZOOM_CATSMGR_DESCR","Crie, edite ou remova galerias");
define("_ZOOM_SETTINGS_DDONOF","Ativar Drag n Drop");
define("_ZOOM_NEW","Nova galeria");
define("_ZOOM_DEL","Apagar galeria");
define("_ZOOM_MEDIAMGR","Gerenciador mídia ");
define("_ZOOM_MEDIAMGR_DESCR","Mova, edite, apague, carregue automaticamente mídias ou faça upload (múltiplos) manualmente.");
...
define("_ZOOM_ADMIN_CREATE_DESCR","Construa as tabelas do banco de dados exigidas, de forma que você pode começar a usar o álbum");
...
define("_ZOOM_A_MESS_NOT_SHURE","* Se você não estiver certo, use o padrão \"auto\" ");
define("_ZOOM_A_MESS_SAFEMODE1","Nota: \"Modo Seguro\" está ativado, consequentemente é possível que uploads de imagens muito grandes não funcionem!<br />Você deve ir para o Sistema Administrativo e mudar para FTP-Mode.");
define("_ZOOM_A_MESS_SAFEMODE2","Nota: \"Modo Seguro\" está ativado, consequentemente é possível que uploads de arquivos muito grandes não funcionem!<br />zOOm recomenda ativar o FTP-Mode no Sistema Administrativo.");
define("_ZOOM_A_MESS_PROCESSING_FILE","Processando arquivo...");
define("_ZOOM_A_MESS_NOTOPEN_URL","Não foi possivel abrir a url:");
define("_ZOOM_A_MESS_PARSE_URL","Analisando \"%s\" para imagens... "); // %s = $url
define("_ZOOM_A_MESS_NOJAVA","Se você vê acima apenas uma caixa cinza ou está tendo problemas enquanto baixar novas imagens, deve ser por que você<br />não tem o último java run-time instalado. Visite <a href=\"http://www.java.com\" target=\"_blank\">Java.com</a> <br /> e baixe as versões mais atuais.");
...
define("_ZOOM_SETTINGS_TAB2","Mídia");
define("_ZOOM_SETTINGS_TAB3","Layout");
define("_ZOOM_SETTINGS_TAB4","Marca d água");
define("_ZOOM_SETTINGS_TAB5","Modo Seguro");
define("_ZOOM_SETTINGS_TAB6","Accessibilidade");
define("_ZOOM_SETTINGS_TAB7","Resetar");
define("_ZOOM_SETTINGS_ERASE","Clique para limpar todos os dados da galeria Zoom e começar uma nova. Esta opção irá resetar e remover todas as imagens.");
...
define("_ZOOM_SETTINGS_OVERRIDE_FFMPEG","Usar FFmpeg, mesmo se o zOOm estiver inativo, verifique se este existe no seu sistema.");
...
define("_ZOOM_SETTINGS_OVERRIDE_PDF","Usar PDFtoText, mesmo se zOOm estiver inativo, verifique se este existe no seu sistema.");
define("_ZOOM_SETTINGS_MAXSIZE","Tamanho max. da Imagem: ");
define("_ZOOM_SETTINGS_MAXSIZEKB","Mídia - incluindo imagens - tamanho max. (em kB): "); //added: 08-08-2006
define("_ZOOM_SETTINGS_MAXSIZEKB_WARNING","O limite de upload desse servidor, Marcado no seu ISP como parte da configuração PHP, é %s.<br />Assim, marque um limite maior que este valor poderia não estar em uso!"); //added: 09-01-2006
...
define("_ZOOM_SETTINGS_SHOWOCCSPACE","Mostrar espaço ocupado do Media Manager");
...
define("_ZOOM_SETTINGS_TEMPLATE_CHOOSE","Selecione o template para definir o look &amp; feel de sua galeria");
define("_ZOOM_SETTINGS_TEMPLATE_TABLES","Clássico (com tabelas)");
define("_ZOOM_SETTINGS_TEMPLATE_TABLELESS","Moderno (design sem tablelas)");
...
define("_ZOOM_SETTINGS_SLIDESHOW","Slide show");
define("_ZOOM_SETTINGS_ZOOMLOGO","Mostrar logo zOOm");
define("_ZOOM_SETTINGS_SHOWHITS","Mostrar núm. de cliques");
...
define("_ZOOM_SETTINGS_CSS","Janela Popup CSS");
...
define("_ZOOM_SETTINGS_ORDERBY","Método ordenação thumbnail; ordenado por");
define("_ZOOM_SETTINGS_CATORDERBY","Método ordenação (Sub)galeria; ordenado por");
define("_ZOOM_SETTINGS_DATE_ASC","Data, crescente");
define("_ZOOM_SETTINGS_DATE_DESC","Data, decrescente");
define("_ZOOM_SETTINGS_FLNM_ASC","Nome do arquivo, crescente");
define("_ZOOM_SETTINGS_FLNM_DESC","Nome do arquivo, decrescente");
...
define("_ZOOM_SETTINGS_SHOWUNAME","Mostrar nome do usuário");
...
define("_ZOOM_SETTINGS_LASTSUBM","Mostrar link \"Últimos arquivos enviados\" na página principal");
define("_ZOOM_SETTINGS_SETMENUOPTION","Mostrar o link \"Upload imagens\" no menu do usuário");
...
define("_ZOOM_SETTINGS_PRIV_DESCR","Você pode  mudar os privilégios de cada grupo conhecido no Joomla! e mudar por este meio os privilégios de cada usuário que é um membro desse grupo!<br/> Um usuário, na teoria, fazer as seguintes ações:  subir o arquivo(s), editar/apagar imagens, críar/editar/apagar galerias(compartilhadas).<br/> O que eles podem e não podem fazer no mundo real é com você.");
define("_ZOOM_SETTINGS_CLOSE","Mostra link \"Fechar\" no popup");
define("_ZOOM_SETTINGS_MAINSCREEN","Mostrar barra de navegação na tela principal");
define("_ZOOM_SETTINGS_NAVBUTTONS","Mostrar botões da barra de navegação no popup");
define("_ZOOM_SETTINGS_PROPERTIES","Mostrar propriedades abaixo");
define("_ZOOM_SETTINGS_MEDIAFOUND","Mostrar texto \"Mídia encontrado\" na galeria");
define("_ZOOM_SETTINGS_ANONYMOUS_COMMENTS","Permitir comentário anônimo");
define("_ZOOM_SETTINGS_WM_ENABLE_TITLE","Ativar função"); 
define("_ZOOM_SETTINGS_WM_TITLE", "Sua marca d água"); 
define("_ZOOM_SETTINGS_WM_DESCR", "Sua marca d água aparece no topo de suas imagens do seu site. " 
    . "A imagem ainda estará visível, mas os visitantes não poderão tentar copiar ou imprimir." 
    . "<br /><br />Sugestão: você pode usar o logotipo da empresa como marca d água. " 
    . "Por favor, tenha certeza que você setou o fundo da marca d água como transparente!"); 
define("_ZOOM_SETTINGS_WM_IMG", "Imagem"); 
define("_ZOOM_SETTINGS_WM_NOWATERMARKS", "Marca d água não encontrado. Você poderá enviar uma nova marca d água abaixo."); 
define("_ZOOM_SETTINGS_WM_PLACEMENT_TITLE", "Localização"); 
define("_ZOOM_SETTINGS_WM_PLACEMENT_DESCR", "Você pode definir a posição da marca d água na imagem-alvo " 
    . "selecionando uma das posições no quadro cinza abaixo."); 
define("_ZOOM_SETTINGS_WM_FILE","Envio da marca d água"); 
define("_ZOOM_SETTINGS_WM_UPLOAD_SUCCESS","Marca d água foi enviado com sucesso!"); 
define("_ZOOM_SETTINGS_WM_UPLOAD_FAIL","O envio da marca d água falhou."); 
define("_ZOOM_SETTINGS_WM_DEL_SUCCESS","Marca d água apagado com sucesso!"); 
define("_ZOOM_SETTINGS_WM_DEL_FAIL","Marca d água não poderia ser apagado."); 
...
define("_ZOOM_ALERT_MOVE","%s mídias movidas com sucesso, %s midias não podem ser movidas.");
...
define("_ZOOM_UPLOAD_SINGLE","Arquivo (ZIP)");
define("_ZOOM_UPLOAD_MULTIPLE","Múltiplos arq.");
define("_ZOOM_UPLOAD_DRAGNDROP","Arrastar & Soltar");
define("_ZOOM_UPLOAD_SCANDIR","Upload diretório");
define("_ZOOM_UPLOAD_INTRO","Clique no botão <b>Procurar</b> para localizar a imagem para upload.");
define("_ZOOM_UPLOAD_STEP1","1. Selecione o número de imagens que deseja fazer upload: ");
...
define("_ZOOM_SCAN_STEP2","Step 2: Selecione os arquivos que deseja fazer upload...");
define("_ZOOM_SCAN_STEP3","Step 3: zOOm processa os arquivos selecionados...");
define("_ZOOM_SCAN_STEP1_DESCR","O local pode ser tanto uma URL quanto um diretório no Servidor.<br />&nbsp;   Dica: upload imagens (FTP) para um diretorio no seu servidor, e aponte o caminho aqui!");
...
define("_ZOOM_FORM_IGNORESIZES","Ignorar dimensão max. da imagem pré-configurada"); //added: 12-08
...
define("_ZOOM_CONFIRM_WIPE","Atenção!\\n Executando essa função irá limpar completamente sua galeria zOOm e remover todas as imagens e galerias.\\n\\n Você tem certeza que quer continuar?");
define("_ZOOM_CONFIRM_DEL","Esta opção vai remover a galeria completamente, incluindo as imagens!\\nVocê deseja prosseguir?");
define("_ZOOM_CONFIRM_DELMEDIUM","Você irá remover completamente esta mídia!\\nVocê deseja prosseguir?");
...
define("_ZOOM_ALERT_MOVEFAILURE","Mídia não pode ser movida."); //added: 08-08-2006
...
define("_ZOOM_ALERT_TOOBIG","O tamanho do arquivo é muito grande; %s é o max. permitido"); //added 08-08-2006
...
define("_ZOOM_ALERT_WATERMARKERROR","Erro ocorrido enquanto estava tentando aplicar a marca d água na imagem.");
...
define("_ZOOM_SLIDESHOW","Slide Show:");
define("_ZOOM_PREV_IMG","Anterior");
define("_ZOOM_NEXT_IMG","Próxima");
define("_ZOOM_FIRST_IMG","Primeira");
define("_ZOOM_LAST_IMG","Última");
...
define("_ZOOM_IN_DESC", "Coloque seu mouse sobre a imagem e pressione a tecla UP ou DOWN.");

//Gallery actions
define("_ZOOM_SEARCH_BOX","Procura nesta galeria...");
...
define("_ZOOM_IMGFOUND","%s mídias encontradas - você está na página %s de %s");
...
define("_ZOOM_PASS","Senha");
define("_ZOOM_PASS_REQUIRED","Esta galeria precisa de uma senha.<br />Por favor, preencha o campo da senha<br />e pressione o botão OK. Obrigado.");
...
define("_ZOOM_ECARD_YOUREMAIL","Seu endereço de e-mail");
...
//installation-screen
define ('_ZOOM_INSTALL_CREATE_DIR','A instalação do zOOm está criando o diretório de imagens "images/zoom" ...');
define ('_ZOOM_INSTALL_CREATE_DIR_WM','A instalação do zOOm está tentando criar o diretório de imagens "images/zoom/watermarks" ...');
define ('_ZOOM_INSTALL_CREATE_DIR_SUCC','feito!');
define ('_ZOOM_INSTALL_CREATE_DIR_FAIL','falhou!');
define ('_ZOOM_INSTALL_CREATE_DBASE_SUCC','Base de Dados criado com sucesso!');
define ('_ZOOM_INSTALL_UPGRADED_DBASE_SUCC','Base de Dados atualizado com sucesso!');
