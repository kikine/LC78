...
|                                                                     |
-----------------------------------------------------------------------
* @version $Id: template.view.php,v 1.12 2006/11/12 06:18:30 kevinuru Exp $
* @package zOOmGallery
* @subpackage Template
...
class ZMG_Template_View {
    ...
    function showTypeDocument($thumbnail, $popup) {
        ?>
		<img src="<?php echo $thumbnail; ?>" alt="" border="1" name="zImage"<?php echo ($popup) ? " onclick=\"javscript:window.close()\"" : ""; ?> />
		<?php
    }
