...
|                                                                     |
-----------------------------------------------------------------------
* @version $Id: template.gallery.php,v 1.19 2006/12/08 01:21:00 kevinuru Exp $
* @package zOOmGallery
...
class ZMG_Template_Gallery {
    ...
    function showGalleryListButton($use_tables = true, $Itemid, &$gallery, $no_columns, $gallery_prefix, $show_catimg, $show_metabox) {
        ...
        if ($use_tables) {
            ...
            if ($show_catimg) {
                ?>
                <td align="left" valign="top" width="<?php echo number_format((100/$no_columns), 0, '.', ''); ?>%"><a href="<?php echo sefRelToAbs("index".$backend.".php?option=com_zoom&amp;Itemid=".$Itemid."&amp;catid=".$gallery->_id);?>" <?php echo ($show_metabox) ? "onmouseover=\"return overlib('".$img_num." "._ZOOM_IMAGES.$subcat_html."', CAPTION, '".addslashes($gallery->_name)."');\" onmouseout=\"return nd();\"" : "";?>>
                ...
                ?>
                <td align="left" valign="top" width="50%"><a href="<?php echo sefRelToAbs("index".$backend.".php?option=com_zoom&amp;Itemid=".$Itemid."&amp;catid=".$gallery->_id);?>" <?php echo ($show_metabox) ? "onmouseover=\"return overlib('".$img_num." "._ZOOM_IMAGES.$subcat_html."', CAPTION, '".addslashes($gallery->_name)."');\" onmouseout=\"return nd();\"" : "";?>>
                <?php
            }
            ...
            if ($show_catimg) {
                ...
                <a href="<?php echo sefRelToAbs("index".$backend.".php?option=com_zoom&amp;Itemid=".$Itemid."&amp;catid=".$gallery->_id);?>" <?php echo ($show_metabox) ? "onmouseover=\"return overlib('".$img_num." "._ZOOM_IMAGES.$subcat_html."', CAPTION, '".addslashes($gallery->_name)."');\" onmouseout=\"return nd();\"" : "";?>>
